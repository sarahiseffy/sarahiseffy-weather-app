...
function refreshWeather(response) {
  ...
  timeElement.innerHTML = formatDate(date); //targets the time value element id
}
...
if (minutes < 10) { //if the time is less than 10 hours, to add "0" before the minutes value (example 1:01 instead of 1:1)
  minutes = `0${minutes}`;
}
